...
const LEGENDS: LegendConfig[] = [
  ...
  },
  {
    layerId: 'wind',
    label: 'Wind Flow',
    gradient: 'linear-gradient(90deg, rgba(180,220,255,0.2), rgba(180,220,255,0.5), rgba(100,180,255,0.8))',
    min: 'Calm',
    max: 'Strong',
  },
  {
    ...
    label: 'Radar',
    gradient: 'linear-gradient(90deg, #1e3a5f, #2563eb, #06b6d4, #22c55e, #eab308, #ef4444)',
    min: 'Light',
    max: 'Heavy',
  },
  {
